     ...
     <BrowserRouter>
       <Routes>
        ...
        <Route path='/service' element={<Service />}>
          {/* NESTED KARIYE TYRE PATH MA / APVO NAI */}
          {/* JO APRE PARAMETER MATHI ID LEVANI HOI TO COMPULSURY : LAKHO PROPERTY NU NAME APVU AA PROPERTY APRE NE SERVICE VALA PARENT COMPONENT MA USE PARAMS NI UNDER MLSE */}
          <Route path=':number'/>
        </Route>
       </Routes>
     </BrowserRouter>
